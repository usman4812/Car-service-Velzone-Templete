                        ...
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            <div>
                                <a href="index.html" class="d-inline-block auth-logo">
                                    <img src="{{asset('assets/images/logo-lite-car.jpg')}}" alt="" height="100">
                                </a>
                            </div>
                            <p class="mt-3 fs-15 fw-medium">Smart Auto & Accessories Fitting</p>
                        </div>
                    </div>
                </div>
                <!-- end row -->
                        ...
                        <div class="card mt-4 card-bg-fill">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">Sign in to continue to Smart Auto.</p>
                                </div>
                                <div class="p-2 mt-4">
