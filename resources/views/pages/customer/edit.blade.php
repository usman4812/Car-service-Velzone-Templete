                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="name" class="form-control"
                                            placeholder="Enter Full Name" id="name" value="{{ $customer->name}}" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="phone" class="form-control" placeholder="Enter Phone" value="{{ $customer->phone}}" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
