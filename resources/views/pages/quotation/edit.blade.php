...
@section('content')
        ...
        <div class="col-xxl-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Edit Quotation</h4>
                </div><!-- end card header -->
                <div class="card-body">
                    <div class="live-preview">
                        <form action="{{ route('making-quotation.update', $quotation->id) }}" method="POST" enctype="multipart/form-data">
                            @method('PUT')
                            @csrf
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <label for="date" class="form-label">Date<span class="text-danger">
                                                *</span></label>
                                        <input type="date" name="date" class="form-control" value="{{ $quotation->date }}" required>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="customer_name" class="form-control" id="customer_name"
                                            placeholder="Enter Customer Name" value="{{ $quotation->customer_name }}" required>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="email" name="customer_email" class="form-control" id="customer_email"
                                            placeholder="Enter Email Address" value="{{ $quotation->customer_email }}">
                                    </div>
                                </div>
                                <!--end col-->
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="customer_phone" class="form-control"
                                            placeholder="Enter Mobile Phone" id="customer_phone" value="{{ $quotation->customer_phone }}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="car_model" class="form-control"
                                            placeholder="Enter Car Model" id="car_model" value="{{ $quotation->car_model }}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="car_plat_no" class="form-control"
                                            placeholder="Enter Car Plate No" id="car_plat_no" value="{{ $quotation->car_plat_no }}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="chassis_no" class="form-control"
                                            placeholder="Enter Chassis No" id="chassis_no" value="{{ $quotation->chassis_no }}">
                                    </div>
                                </div>
                                <div class="card">
                                    <div class="card-header align-items-center d-flex">
                                                ...
                                                <div class="row align-items-center mb-3 item-row border-bottom pb-3">
                                                            ...
                                                            <div class="col-md-4">
                                                                <select class="form-select category_id" data-choices
                                                                    ...
                                                                    @foreach ($categories as $id => $name)
                                                                        <option value="{{ $id }}" {{ $id == $item->category_id ? 'selected' : '' }}>
                                                                            {{ $name }}
                                                                        </option>
                                                                    @endforeach
                                                                </select>
                                                    ...
                                                    <div class="col-md-1">
                                                        <input type="number" name="qty[]"
                                                            class="form-control text-center qty" placeholder="0" value="{{ $item->qty }}">
                                                    </div>
                                            ...
                                            <table class="table table-borderless align-middle">
                                                <tr>
                                                    ...
                                                    <td><input type="text" id="amount" name="amount"
                                                            class="form-control text-end" value="{{ number_format($quotation->amount ?? 0, 2) }}" readonly></td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="number" id="net_amount" name="net_amount" step="0.01"
                                                            class="form-control text-end" value="{{ $quotation->net_amount ?? 0 }}" min="0"></td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="text" id="discount_amount" name="discount_amount"
                                                            class="form-control text-end" value="{{ number_format($quotation->discount_amount ?? 0, 2) }}" readonly></td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="number" id="discount_percent" step="0.01"
                                                            ...
                                                            value="{{ $quotation->discount_percent ?? 0 }}" min="0" max="100"></td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="text" id="vat_amount" name="vat_amount"
                                                            class="form-control text-end" value="{{ number_format($quotation->vat_amount ?? 5, 2) }}" readonly></td>
                                                </tr>
                                                ...
                                                <tr class="border-top">
                                                    ...
                                                    <td><input type="text" id="total_payable" name="total_payable"
                                                            class="form-control text-end fw-semibold" value="{{ number_format($quotation->total_payable ?? 0, 2) }}"
                                                            readonly></td>
                                                </tr>
                                            </table>
                                        </div>
    ...
    <script>
        $(document).ready(function() {
            // Initialize netEdited flag based on existing values
            let netEdited = {{ $quotation->discount_amount > 0 || $quotation->discount_percent > 0 ? 'true' : 'false' }};
            let lastDiscountPercent = {{ $quotation->discount_percent ?? 0 }};

            // Load subcategories and products for existing items on page load
            $('.item-row').each(function() {
                var row = $(this);
                var categoryId = row.find('.category_id').val();
                var subCategoryId = row.find('.sub_category_id').val();
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            $.each(data, function(key, value) {
                                var selected = (key == currentSubCategoryId) ? 'selected' : '';
                                subCategoryDropdown.append('<option value="' + key + '" ' + selected + '>' + value + '</option>');
                            });

                            // Load products if subcategory exists
                            if (subCategoryId) {
                                $.ajax({
                                    url: "{{ url('/get-products') }}/" + subCategoryId,
                                    type: "GET",
                                    success: function(productData) {
                                        ...
                                        $.each(productData, function(key, value) {
                                            var selected = (key == currentProductId) ? 'selected' : '';
                                            productDropdown.append('<option value="' + key + '" ' + selected + '>' + value + '</option>');
                                        });
                                    }
                                });
                            }
                ...
                if (product_id) {
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            var currentQty = parseFloat(row.find(".qty").val()) || 1;
